...
public class SkillData {
    ...
    public void addActive(String name, int hits, double min, double max, double hit, double mp, double cast_mult, double delay_mult,
        ...
        active_skills.put(name, new ActiveSkill(owner, name, hits, min, max, hit, mp, cast_mult, delay_mult, scaling,
                element, aoe, heal, weapon_required));
    }
    ...
    public void activeSkillData() {
        ...
        addActive("Arrow Rain", 5, 49.5, 60.5, 0.7, 25, 1.5,
                1.5, Scaling.atkhit, Element.phys, false, false, "bow");
        ...
        addActive("Fire Pillar", 1, 180, 220, 1.0, 50, 1.5,1.5, Scaling.intel, Element.fire, false, false, "wand");
        active_skills.get("Fire Pillar").addDebuff("Burn", 3, 1);
        addActive("Explosion", 1, 1350, 1650, 1.15, 500, 8, 30, Scaling.intel,
                Element.fire, true, false, "wand");
        active_skills.get("Explosion").addDebuff("Burn", 3, 1);
        addActive("Rock Shot", 1, 198, 242, 1.0, 55, 1.8,1.0, Scaling.intel, Element.earth, false, false, "wand");
        active_skills.get("Rock Shot").addDebuff("Stun", 0, 3);
        addActive("Earth Quake", 1, 315, 385, 1.2, 350, 3,6, Scaling.intel, Element.earth, true, false, "wand");
        ...
        addActive("Holy Light", 1, 112.5, 137.5, 1.0, 25, 1, 1.1, Scaling.resint,
                Element.light, false, false, "book");
        ...
        addActive("Throw Sand", 1, 0, 0, 1, 20, 0.8, 0.5, Scaling.atk, Element.phys,
                false, false);
        active_skills.get("Throw Sand").addDebuff("Sand", 3, 0);
        ...
        addActive("Water Punch", 1, 99, 121, 1, 10, 0.9, 0.9, Scaling.atkint, Element.water,
                false, false);
        addActive("Tsunami", 1, 252/0.7, 308/0.7, 1, 150, 4, 6, Scaling.intel, Element.water, true, false, "wand");
